...
public class TaiKhoan {
    ...
    public void EditTaiKhoan(String oldTk,String tk,String pa,Boolean ad) throws SQLException{
         cn.connectSQL();
         String sql ="Update TaiKhoan set Username ='"+tk+"',Password='"+pa+"',CapDo='"+ad+"' where Username like '"+oldTk+"'";
         cn.UpdateData(sql);
     }
}
